...
window.CFI_SCRIPTS['ii-e-flight-controls-systems'] = { nodes: [
  ...
  P('Fuel, electrical & hydraulic/brake systems'),
  P('Pitot-static & gyroscopic flight instruments'),
  P('Environmental systems & ice protection'),
  H('What'),
  ...
  P('Ailerons control roll (longitudinal axis), elevator controls pitch (lateral axis), rudder controls yaw (vertical axis) — required to safely control the airplane in flight.'),
  A('Ailerons'),
  ...
  P('4 designs fight adverse yaw: differential ailerons (up-travel exceeds down-travel), Frise-type (raised aileron\'s leading edge juts into the airflow), aileron-rudder interconnects, and flaperons (ailerons that also droop together as flaps).', 3),
  A('Elevator'),
  P('Pulling back raises the trailing edge, increases downward tail force, and pitches the nose up; pushing forward does the reverse. T-tails sit clear of prop wash (consistent control) but need more elevator at slow speed and are more susceptible to a deep stall. A stabilator is an all-moving tail with an anti-servo tab to prevent overcontrolling.'),
  ...
  A('Rudder'),
  P('Deflecting into the airflow creates a horizontal force that yaws the nose in that direction — used to maintain coordination, especially against adverse yaw and left-turning tendencies. V-tails use ruddervators, mixed by linkage, to do the job of both elevator and rudder — more complex and more prone to Dutch roll.'),
  ...
  A('Spoilers'),
  P('Spoil lift and add drag on purpose — steepen descents without gaining airspeed, dump lift on landing to plant the wheels for braking, and (used one wing at a time) assist roll without the adverse yaw ailerons cause.'),
  A('Trim Systems'),
  ...
  P('High oil temp: plugged line, low quantity, blocked cooler, or bad gauge. Low oil temp: wrong viscosity for cold weather.', 3),
  A('Cooling & Exhaust'),
  ...
  B('FADEC (where installed) runs ignition and fuel electronically with two redundant channels — but losing FADEC entirely means losing engine power, so know the backup.'),
  ...
  P('Tanks are vented (atmospheric pressure) and drain through a strainer that traps water and sediment — drain it before every flight; water is the #1 contaminant, shown by cloudy fuel or a clear separation layer.'),
  ...
  P('Most GA aircraft run 14- or 28-volt DC: alternator/generator, battery, master switch, bus bar, fuses/breakers, voltage regulator, and an ammeter or loadmeter.'),
  ...
  A('Heating'),
  P('Exhaust-shroud heat is simplest and most common on trainers — inspect the exhaust for cracks, since that same air goes straight to the cabin. Combustion heaters (larger aircraft) add an overheat switch and are pressure-designed so a leak vents outward, not into the cabin. Bleed-air heat serves turbine aircraft.'),
  A('Pressurization'),
  ...
  P('Pneumatic deice boots inflate to crack ice off the leading edge, cycled singly or on an automatic timer. Thermal anti-ice bleeds hot air to the leading edge, activated before entering icing conditions. Weeping-wing systems ooze antifreeze through the leading edge — capable of both deice and anti-ice.'),
  ...
  S('Conclusion'),
  P('Review: primary & secondary controls · trim · flaps · engine 4-stroke/ignition/induction/oil/cooling · propeller fixed vs constant-speed · fuel · electrical · gear/brakes · pitot-static · vacuum/gyro · environmental · ice protection.'),
  P('The instructor\'s real job with systems: know each one well enough to recognize immediately when it is NOT behaving normally.'),
]};
...
window.CFI_SCRIPTS['xiv-a-after-landing'] = { nodes: [
  ...
  H('Parking'),
  A('Parking Location — Clear of Propeller & Jet Blast'),
  P('Pick a spot and heading that keeps your prop or jet blast off other airplanes — and keeps theirs off you. Park into the wind if you can, and use hand signals if ramp personnel are marshaling you.'),
  P('After stopping, roll forward slightly to straighten the nosewheel.', 3),

  H('Engine Shutdown — AI.XIV.A.K1'),
  P('Set the parking brake once stopped, then follow the manufacturer\'s checklist item by item — read it, then do it.'),
  A('Grounding the mags'),
  P('Common practice: with the engine running, cycle the ignition from BOTH to OFF and back to BOTH to confirm the mags are actually grounded.'),
  ...
  P('Brief passengers on the safe way to exit — and on hazards nearby, like other aircraft starting or taxiing. Nobody gets out until the checklist is complete and it is actually safe.'),

  H('Postflight Inspection — AI.XIV.A.K1'),
  P('Walk the airplane: look for damage, leaks, streaks, and stains, and check oil and other fluids, topping off as needed.'),
  A('Document every discrepancy — AI.XIV.A.K2'),
  P('It gets fixed, it warns the next pilot so they can make an informed go/no-go, and it surfaces trends before they become failures. Don\'t leave your problem for someone else to find.'),

  H('Fuel & Secure — AI.XIV.A.K1'),
  P('Fuel for the next flight\'s actual requirements — or top off if the airplane will sit, to keep condensation out of the tanks.'),
  A('Securing checklist'),
  P('Personal items out, nosewheel straight, parking brake/tiedown/chocks as needed, controls secured (gust locks), covers on or hangared, windows closed, locked.'),
  ...
  P('Scope out parking and ramp space at the destination ahead of time.'),
  B('If something is off, ask — don\'t assume it will be okay, and don\'t make the go/no-go decision for the next pilot. Verify with the POH, an instructor, the chief pilot, or maintenance.'),
  ...
  P('Work the checklist step by step, and don\'t skip the postflight assuming the next pilot\'s preflight will catch it.'),

  S('Conclusion'),
  P('Review: parking · shutdown · deplaning · postflight inspection · documenting discrepancies · fueling · securing · airport security · sterile flight deck.'),
...
window.CFI_SCRIPTS['v-a-preflight-assessment'] = { nodes: [
  ...
  A('P — Pilot'),
  P('Run IMSAFE — Illness, Medication, Stress, Alcohol, Fatigue, Emotion — before anything else.'),
  A('A — Aircraft — AI.V.A.R2'),
  P('Required documents and inspections current, equipment and systems operational, properly loaded, and within its performance capability for the flight.'),
  A('V — enVironment — AI.V.A.K4,AI.V.A.R3'),
  P('Current versus forecast weather, terrain and day/night considerations, and the full departure-route-destination-alternate picture: airspace, TFRs, NOTAMs.'),
  A('Aviation Security — AI.V.A.R5'),
  P('GA is a soft target: minimal security at small fields, often unattended. Report suspicious activity to 1-866-GA-SECURE, or 911 for an immediate threat.'),
  P('Flight schools add their own layer: TSA security-awareness training, background checks, employee ID, and controlled access to aircraft and keys.', 3),
  ...
  H('The Preflight Checklist — Basics'),
  P('The inspection moves logically around the airplane — it starts the moment you walk up on the ramp and notice the overall picture.'),
  ...
  P('Airworthiness documents (AROW), logbook compliance, and every preflight-checklist item that lives inside the cabin — lights, pitot heat, and the like.'),
  A('Exterior of the airplane'),
  P('Follow the checklist around the entire airframe — the failure mode here is not recognizing a discrepancy as a discrepancy.'),
  ...
  P('Water sinks to the low points, sediment comes from dust and dirt — sump it and check the color and clarity.', 3),
  ...
  H('Loading & Securing'),
  P('Verify the CG is within limits before you load anything, then secure everything so nothing shifts or becomes a projectile in turbulence.'),
  H('Determining the Airplane Is Safe — AI.V.A.K2'),
  P('Note every discrepancy found during the preflight and make an honest go/no-go call — when in doubt, get a second opinion from a CFI or mechanic.'),
  ...
  S('Conclusion'),
  P('Review: PAVE (Pilot · Aircraft · enVironment · External) · IMSAFE · AROW · what to inspect inside and out · detecting structural, control, fuel, oil, and ice problems · loading & securing · the PIC\'s final go/no-go.'),
...
window.CFI_SCRIPTS['v-b-flight-deck-mgmt'] = { nodes: [
  ...
  P('Get every document, checklist, and chart on board and organized so it\'s reachable without a search.'),
  P('Check for loose items that could become a hazard in turbulence — good flight-deck housekeeping pays off on every single flight.'),
  A('Common error'),
  P('Failing to place or secure essential materials and equipment for easy access in flight.'),

  H('Seat Position & Controls'),
  P('Belt/harness snug and comfortable, seat locked in the same position every flight, rudder pedals adjusted for full range of motion.'),
  A('Common errors'),
  P('Skipping the adjustment of belts, harnesses, pedals, or seat before moving.'),

  H('Navigation Data Currency — AI.V.B.K3'),
  P('FAR 91.103 requires familiarity with all available information for the flight — carry current charts even though it isn\'t explicitly mandated.'),
  P('Databases must be current for IFR (AIM 1-1-17); current is still the right call for VFR even without a hard requirement.'),
  P('No enforcement action for an old chart alone — but if it contributed to an incident under investigation, it becomes evidence.', 3),

  H('Checklist Usage — AI.V.B.K2'),
  B('Never go from memory — the manufacturer\'s checklist, in order, every time, ensures every item is actually checked.'),

  H('RM: Inoperative Equipment — AI.V.B.R2'),
  A('On the ground'),
  P('Thorough preflight, then defer and placard per FAR 91.213(d) — see III.B. Airworthiness Requirements.'),
  P('Legal isn\'t the same as safe — set your own equipment minimums.', 3),
  A('Airborne'),
  P('If something goes inoperative in flight: would it have grounded you on the ground? How does it change the rest of the flight or your personal minimums?'),

  S('Resources, Distractions & Automation'),
  H('Resource Utilization'),
  A('Internal'),
  P('POH, checklists, charts, tablet data, a thorough understanding of your own equipment, and your passengers — they can look for traffic too.'),
  A('External'),
  P('Maintenance, Flight Service (1-800-WX-BRIEF), internet research before the flight, ATC, other aircraft\'s PIREPs, ASOS/AWOS.'),
  A('Common error'),
  ...
  P('Set expectations in the preflight brief; if a passenger is distracting in flight, say so directly and ask them to stop.'),
  A('Automation & PEDs — AI.V.B.R1'),
  B('Understand what the automation is doing before you rely on it — and stay proficient enough to fly the airplane without it.'),

  H('Case Study: Eastern 401'),
  P('A full crew, distracted by a landing-gear indicator bulb, let the autopilot disengage and flew a working airplane into the Everglades.'),
  ...
  P('Risk management concepts to discuss: excess reliance on technology, loss of SA, distractions, systems understanding, and task prioritization — and how to mitigate each.', 3),
...
window.CFI_SCRIPTS['v-c-engine-starting'] = { nodes: [
  ...
  H('Overview'),
  P('Safety precautions before and during start'),
  ...
  P('Fuel-injected engines can vapor-lock — hot-start procedures purge the vapor from the lines.', 3),
  ...
  S('Conclusion'),
  P('Review: before-start clearance and the CLEAR call · hand on the throttle, watch oil pressure · cold vs. hot start technique · external power · hand-propping roles and setup.'),
...
window.CFI_SCRIPTS['v-d-taxiing-signs-lighting'] = { nodes: [
  ...
  P('Signs, markings & lighting — brief overview (covered in depth elsewhere)'),
  H('What'),
  ...
  P('Read back all clearances and verify the route on the taxi diagram — no nonessential tasks while talking to ATC.'),
  B('RM: eliminate expectation bias — read back what was actually said, not what you expected to hear.'),
  A('Clearance required to'),
  P('Enter the movement area, taxi/take off/land with a tower in operation, and cross any runway — each crossing gets its own explicit clearance.'),
  A('Contact Ground before entering the movement area'),
  P('State aircraft ID, location, and intentions; expect the runway, the route, and any hold-short or crossing instructions.'),
  ...
  P('Know local procedures, pattern direction, and altitude ahead of time.'),
  P('Monitor and announce on CTAF from engine start through 10 miles out; build situational awareness from what you hear, not just what you see.'),

  H('Plan, Brief, Review — AI.V.D.K7a'),
  A('Plan'),
  P('Airport diagram and Chart Supplement reviewed, standard taxi routes and NOTAMs checked, a likely route in mind before you call for taxi.'),
  A('Brief'),
  P('Passenger safety brief (see V.B. Flight Deck Management), fuel and equipment status, the expected route, and any hot spots.'),
  A('Record & review'),
  P('Write down the taxi clearance, then review it — query ATC the moment anything is unclear. It beats a mistake, and keeps your head up and eyes outside.'),

  H('RM: Sterile Flight Deck & Activities — AI.V.D.K7a,AI.V.D.R1'),
  B('All heads-down work — checklists, data entry — happens before you move or after you\'re fully stopped, never while taxiing.'),
  P('Run a continuous loop near other aircraft: where they are now, where their clearance says they\'re going next.'),

  S('Taxi Technique'),
  H('Basics'),
  P('Steering: rudder for direction, inside brake to tighten a turn; release rudder pressure just before the turn reaches where you want it to stop.'),
  P('Brakes: smooth and even, used to stop, slow, or assist a turn — don\'t ride them.'),
  P('Speed: a fast walk, controlled first with power, second with brakes.'),
  P('Stopping: nosewheel straight, to prevent side-loading and keep the next start easy.'),
  A('Common errors'),
  P('Taxiing too fast for the conditions, and rough or imprecise brake use.'),
  H('Taxi Checks'),
  P('Brakes tested the moment the airplane starts moving; attitude indicator within 5° of pitch/bank; turn coordinator and inclinometer confirm coordinated turns; compass swinging toward known headings.'),
  H('Aircraft Lighting — AI.V.D.K6'),
  P('Beacon with engines running; nav, position, and anti-collision lights before taxi; taxi light on while moving, off when stopped or yielding.'),
  P('All exterior lights on to cross a runway; every light but the landing light on to enter one; landing light on with takeoff clearance or at the start of the roll.'),

  H('Wind Corrections — AI.V.D.K5'),
  A('Reading the wind'),
  P('ATIS, ATC, or FSS give wind direction; the windsock points away from the wind and a tetrahedron/wind tee weathervanes into it — usually located centrally near the runway.'),
  P('Use the heading indicator to visualize the wind\'s relation to the airplane before a turn.', 3),
  A('Control applications'),
  B('Quartering headwind: ailerons into the wind, elevator neutral. Quartering tailwind: controls positioned to dive away from the wind — and use less power, since the wind is pushing you.'),

  H('Night Operations — AI.V.D.K7d,AI.V.D.K6'),
  P('Exterior lights make you visible to others — on the runway, line up about 3 feet off centerline so you don\'t look like a runway light yourself.'),
  P('Reduced visibility means taxi slower and stay more cautious than you would by day.'),

  H('Low Visibility — AIM 4-3-19 — AI.V.D.K7e'),
  B('Slow, deliberate taxi with full attention outside; sterile flight deck; hold checklists and nonessential calls until stopped with the brakes set.'),
  P('Notify the controller at the first sign of difficulty or disorientation — don\'t try to work it out alone.'),

  H('RM: Runway Incursions — AI.V.D.R4'),
  B('Taxi first: sterile flight deck, eyes outside, stop immediately for any emergency.'),
  P('Know where you are and where you\'re going — taxi diagram out, mental picture of other traffic maintained continuously.'),
  P('Write down complex instructions, read back every crossing and hold instruction, and taxi at a conservative, safe speed.'),

  H('RM: Route or Runway Change — AI.V.D.R3'),
  P('Find a safe place to stop, copy the new instructions, review the route, and request progressive taxi if you need it.'),

  H('Entering/Crossing Runways — AI.V.D.K7c'),
  P('A specific clearance is required to cross every runway, no exceptions.'),
  A('Hold lines'),
  P('From the dashed side: cross without a clearance and stop fully past the solid lines. From the solid side: do not cross without one. Clear both directions before crossing either way.'),
  H('Landing & Rollout'),
  P('Brief the rollout plan before landing; after landing, get the entire aircraft clear of the hold-short line before stopping for taxi instructions; between parallel runways, cross only when cleared.'),

  S('Signs, Markings & Lighting — AI.V.D.K4 (overview only — see II.C. Runway Incursion Avoidance for full depth)'),
  H('Airport Markings'),
  P('Runway: designators, centerline, aiming point, touchdown zone, side stripes, shoulders. Taxiway: yellow centerline, double-yellow edges, surface-painted signs, geographic position markings, and the four-line holding position marking.'),
  H('Airport Signs'),
  P('Red = mandatory instruction, a clearance is required. Black-on-yellow = location ("you are here"). Yellow-on-black = direction/destination/information. Black-on-white = runway distance remaining.'),
  B('CE: failure to comply with airport, runway, or taxiway signs and markings.'),
  H('Airport Lighting'),
  P('Blue taxiway edge / green taxiway centerline; white runway edge with an amber caution zone; green threshold / red end; Runway Status Lights flash red in the pavement when a runway is unsafe to enter — stop regardless of your clearance and ask.'),
  B('CE: failure to comply with airport, runway, or taxiway lighting.'),
  P('Full marking, sign, and lighting detail lives in II.C. Runway Incursion Avoidance — this lesson is about moving the airplane correctly once you can already read them.', 3),

  S('Conclusion'),
  P('Review: taxi clearances & readbacks · plan-brief-review · sterile flight deck · steering, braking, and speed technique · wind corrections · night and low-vis taxi · incursion prevention · hold lines · signs/markings/lighting overview.'),
...
window.CFI_SCRIPTS['v-f-before-takeoff-check'] = { nodes: [
  ...
  P('Done near the runway or run-up area, giving oil temperature time to reach minimums for safe internal clearances.'),
  P('Pick firm, debris-free ground with nothing behind you that prop blast could damage; point into the wind and straighten the nose before running up.'),
  A('Common error'),
  P('Improper positioning of the airplane for the run-up.'),

  H('RM: Division of Attention — AI.V.F.R1'),
  B('Split attention inside and outside — too much head-down time during the checklist means unmonitored aircraft movement.'),

  H('The Checklist — AI.V.F.K1a,K1b,K1c'),
  P('Prepares the airplane and checks the critical systems before flight — always the manufacturer\'s checklist, never memory.'),
  B('Action: talk through why each item matters and how a failed check would show itself, not just the item name.'),
  ...
  P('Ask: are we still legal? Can this be fixed? Is it safe? — any doubt sends you back to the ramp.'),
  A('Common error'),
  P('Accepting marginal engine performance instead of investigating it.'),

  H('RM: Departure Brief — AI.V.F.R4'),
  P('Before takeoff, review performance speeds, expected takeoff distance, and what you\'ll do if something goes wrong.'),
  ...
  P('Visually clear the runway and the final approach path — remember, uncontrolled fields don\'t require a radio call to enter.'),
  ...
  B('Clear left, right, and center before moving; monitor the frequency; repeat every clearance; never cross a hold-short line without one.'),
  ...
  P('Reassess performance for the new runway\'s length, wind, gradient, and terrain; update navigation and re-brief the departure.'),
  P('Review the new taxi diagram, request and read back updated taxi instructions, and confirm the route before moving again.'),
...
window.CFI_SCRIPTS['vi-a-coms-light-signals-rway-lights'] = { nodes: [
  ...
  P('Understanding is the single most important goal of any transmission — if you\'re not sure, ask for clarification.'),
  P('Acknowledge every call with your call sign, keep it brief but complete, and use standard phraseology from the Pilot/Controller Glossary.'),
  A('RM: radio technique'),
  P('Listen and think before you transmit — know what you\'re going to say before you key the mic.'),
  P('Check volume, frequency, and that the mic isn\'t stuck transmitting if things go quiet.'),
  A('The formula'),
  ...
  B('Write it down, then read it back — always read back the "numbers" (altitudes, vectors, runway assignments) and all taxi and LAHSO instructions.'),
  ...
  P('Look up ATIS, clearance, ground, tower, and other useful frequencies for departure, arrival, and any divert airport before you fly.'),
  P('If you need one in flight, stay organized — planning documents accessible, autopilot flying the airplane while you look.'),
  ...
  P('Basic Radar Service (safety alerts, traffic advisories), TRSA sequencing, Class C separation/sequencing, Class B full separation and sequencing.'),
  ...
  P('Mode A sends identity and position; Mode C adds altitude; Mode S adds a unique ICAO address, heading, and speed — feeding TCAS and ADS-B.'),

  S('Lost Communications & Runway Status Lights'),
  H('Lost Communication — AI.VI.A.K3,AI.VI.A.K6'),
  ...
  A('ATC Light Gun Signals — AIM 4-3-13'),
  ...
  P('Limitation: you have to actually be looking at the tower when the signal comes.', 3),
  A('Airborne procedures'),
  P('Receiver inoperative: stay outside the airspace until you\'ve read the traffic flow, advise tower of the failure and your intentions any way you can, then enter the pattern watching for light signals.'),
  P('Transmitter inoperative: same pattern entry, but keep transmitting — they may be able to hear you even if you can\'t hear them.', 3),
  ...
  P('An automated system that turns red in-pavement lights on when it\'s unsafe to enter, cross, take off, or land — installed at major airports, and it must agree with ATC instructions.'),
  A('Runway Entrance Lights'),
  P('Warn you at a hold line that there\'s conflicting traffic on the runway.'),
  A('Takeoff Hold Lights'),
  P('Warn you in takeoff position that the runway ahead is occupied.'),
  ...
  S('Conclusion'),
  P('Review: phraseology & the who-where-what formula · reading back the numbers · distress vs. urgency · frequencies & radar assistance · transponder codes · lost-comm procedures & light signals · runway status lights.'),
...
window.CFI_SCRIPTS['ix-a-steep-turns'] = { nodes: [
  ...
  P('Common errors'),
  P('RM — division of attention, low altitude, collision avoidance'),
  H('What'),
  ...
  H('The Science Behind It — AI.IX.A.K3'),
  ...
  P('Rate = degrees per second; radius = size of the circle. Increasing bank raises rate and shrinks radius. Increasing airspeed does the opposite.'),
  ...
  P('VA increases with weight, but a heavier airplane is already closer to critical AOA and can absorb fewer extra Gs before stalling — the margin doesn\'t actually grow.', 3),
  B('Fly every maneuver, steep turns included, at or below VA.'),

  S('How: Performing the Steep Turn — AI.IX.A.K1, K2'),
  H('Before Starting'),
  P('Altitude no lower than 1,500\' AGL · pre-maneuver checklist · clearing turns (the rapid rate of turn makes this extra important) · entry speed at or below VA · trimmed, straight-and-level.'),
  H('Entering the Turn'),
  ...
  B('Action: apply rudder with the aileron through the roll-in — uncoordinated entries make the rest of the maneuver harder than it needs to be.'),
  P('Passing about 30° of bank, add back pressure for altitude and power for airspeed; establish pitch and bank visually, crosscheck the instruments.', 3),
  H('During the Turn'),
  B('Action: 90% outside, 10% inside — staring at any one reference is the fastest way to bust altitude in a steep turn.'),
  P('Note the entry heading and pick a visual reference point; keep scanning for traffic while tracking where you are in the turn.'),
  ...
  P('Reduce back pressure and power together as bank comes off; remove any up-trim during rollout to avoid ballooning.', 3),
  ...
  P('Crosscheck stays mostly outside with glances inside for airspeed and altitude — orientation means knowing your attitude AND your position relative to traffic, airspace, and terrain.'),
  B('Lost SA? Stop the maneuver, admit it, and get to a safe attitude, airspeed, and altitude before continuing.'),
  H('Task Prioritization'),
  P('Aviate, navigate, communicate — divide attention between flying, scanning, and talking, and recognize the moment you\'re falling behind so you can catch up.'),
  H('Low-Altitude Maneuvering — AI.IX.A.R3'),
  B('A stall or spin at low altitude leaves little to no time to recover — maintain coordination and airspeed, and at the first indication of a stall, recover and climb.'),
  P('Spin recovery is PARE: Power idle · Ailerons neutral · Rudder full opposite the spin · Elevator briskly forward — then neutralize and raise the nose without stalling again.', 3),
  H('Collision Hazards — AI.IX.A.R2'),
  P('Clear in the direction of every turn and keep scanning through the maneuver — above, below, front, and behind.'),
  P('FAR 91.113 right-of-way: aircraft in distress first, then the aircraft to the right (same category) or the less maneuverable one (different categories), then whoever is landing or lower on final.', 3),

  S('Conclusion'),
  P('Review: max performance turn (rate/radius) · load factor & stall speed (60°=2G, 70°≈3G) · overbanking · torque & adverse yaw · VA · 45°/50° bank entry, ½-bank-angle rollout · common errors · division of attention & collision avoidance.'),
...
window.CFI_SCRIPTS['ix-b-steep-spirals'] = { nodes: [
  ...
  P('Roll to an initial bank — 45° is a good starting point — and set the site picture with the reference.'),
  H('During the Spiral'),
  ...
  P('Adjust bank continuously for changing wind to hold a uniform radius — steeper bank with a tailwind (higher groundspeed), shallower as you transition into the headwind.', 3),
  ...
  P('Bug the entry heading and count the turns out loud to hold orientation; there should be no airspeed change transitioning to the glide.', 3),
  ...
  P('Crosscheck stays mostly outside; fixating on one thing lets everything else go. Orientation means aircraft attitude AND position relative to traffic and terrain.'),
  ...
  B('A stall or spin at low altitude leaves little to no recovery time — hold coordination and airspeed, and recover immediately at any stall indication. Recovery is PARE: Power idle, Ailerons neutral, Rudder full opposite the spin, Elevator briskly forward.'),
  H('Collision Hazards — AI.IX.B.R2'),
  P('Clear before and during every turn — above, below, front, behind. FAR 91.113 right-of-way: distress aircraft first, then the aircraft to the right or the less maneuverable category, then whoever is landing or lower on final.', 3),

  S('Conclusion'),
  P('Review: constant ¼-mile radius, bank ≤60° tied to groundspeed · three 360s, no lower than 1,500\' AGL unless it\'s the real thing · triple altitude-loss-per-turn + 1,500\' for entry · roll out within 10° of entry heading · wind & airspeed corrections · common errors · division of attention & collision avoidance.'),
...
window.CFI_SCRIPTS['ix-c-chandelles'] = { nodes: [
  ...
  P('The fastest speed the airplane stalls before exceeding structural limits — above VA, full control deflection can overstress it. VA rises with weight, but a heavier airplane is already closer to critical AOA, so the extra-G margin doesn\'t really grow.'),
  B('Fly the chandelle, like every maneuver, at or below VA.'),
  A('Bank Angle, Load Factor & Stall Speed — AI.IX.C.K2d'),
  P('Load factor (centrifugal force + weight) and stall speed both rise with bank — past 45° the load builds fast: 60° bank = 2 Gs, 70° bank ≈ 3 Gs. Stall speed itself rises with the square root of load factor — 50 KIAS becomes about 85 knots in a 3G turn.', 3),
  P('A chandelle loads the airplane the same way — it will stall at a higher indicated airspeed than usual, so keep every control input smooth; an abrupt one can trigger an accelerated stall.'),
  A('Overbanking Tendency — AI.IX.C.K2b'),
  P('As radius shrinks the outside wing outruns the inside wing and generates more lift, which wants to add bank on its own — worst in the slow, nose-high turn near the top of the chandelle. Counter with opposite aileron.', 3),

  H('RM: Turn Rate & Radius — AI.IX.C.R7'),
  P('Rate = degrees per second, radius = size of the circle. More bank raises rate and shrinks radius; more airspeed does the opposite — minimizing radius and maximizing rate gives the tightest turn for confined areas.'),

  H('RM: Energy Management — AI.IX.C.R6'),
  ...
  P('Altitude gained is not itself a grading criterion — too many variables affect it — but a maximum-performance climb is still the goal.', 3),

  S('How: Performing the Chandelle — AI.IX.C.K1, K3, K4'),
  H('Before Starting'),
  P('Altitude no lower than 1,500\' AGL · pre-maneuver checklist, clear the area · straight-and-level at VA, flaps/gear up · note/bug the entry heading (rollout will be on the reciprocal) · pick a visual reference 90° off the wing in the turn direction.'),
  H('First 90° — Constant Bank, Changing Pitch'),
  P('Smoothly enter a coordinated 30° turn and hold that bank to the 90° point, adjusting for overbanking tendency as speed bleeds off.'),
  ...
  P('Roll out of the bank at a constant rate — about 10° of bank for every 30° of heading change — while holding pitch constant, which takes increasing back pressure as speed keeps decaying.'),
  P('Left-turning tendencies grow stronger here; keep adding right rudder to stay coordinated.', 3),
  ...
  P('Finish by gradually reducing pitch to level flight while accelerating, adding right rudder as pitch comes down to counter gyroscopic precession, then reset pitch, power, and trim for cruise.'),
  ...
  B('A stall or spin at low altitude leaves little to no recovery time — hold coordination and airspeed, and recover at any stall indication. PARE: Power idle, Ailerons neutral, Rudder full opposite the spin, Elevator briskly forward.'),
  H('Collision Hazards — AI.IX.C.R2'),
  P('Clear in the turn direction before starting and keep scanning through the maneuver. FAR 91.113: distress aircraft first, then right-of-way to the right (same category) or less maneuverable (different categories), then whoever is landing or lower on final.', 3),

  S('Conclusion'),
  P('Review: 30° bank through the first 90°, max power + climb to highest pitch · midway airspeed at the 90° point · roll out ~10°/30° through the second 90° while holding pitch · wings level and minimum controllable airspeed at 180° · rudder demands differ left vs. right · common errors · division of attention & collision avoidance.'),
...
window.CFI_SCRIPTS['ix-d-lazy-eights'] = { nodes: [
  ...
  H('Before Starting'),
  P('Altitude no lower than 1,500\' AGL · pre-maneuver checklist, clear the area · straight-and-level at or below VA · pick visual references at 45°, 90°, and 135° in the turn direction, ideally on the horizon.'),
  ...
  H('45° to 90°'),
  P('Bank keeps building at the same rate to reach 30° at the 90° point — opposite aileron may be needed to hold that rate against overbanking.'),
  P('Pitch decreases from its max, passing through level flight exactly at the 90° point — at the same rate it built on the way up. Right rudder pressure peaks here, at the slowest point of the turn.', 3),
  B('90° point: bank at its maximum (about 30°), airspeed at its minimum (5 to 10 knots above stall), pitch passing level.'),
  H('90° to 135°'),
  P('Fly into a descending turn, guiding the nose down to describe the same size loop below the horizon it made above — don\'t dive.'),
  P('Bank decreases to 15° and pitch reaches its maximum-down point by 135° of turn; gravity, thrust, and the forward component of lift do the descending for you. Relax right rudder as speed builds back up.', 3),
  B('135° point: pitch at its minimum, bank at 15°.'),
  H('135° to 180°'),
  P('Continue decreasing bank to wings-level and increasing pitch back to the horizon, both arriving together at the 180° point, back at the starting altitude.'),
  P('Immediately start the next climbing turn in the opposite direction using the same references — the second half should mirror the first as closely as possible.', 3),

  H('RM: Energy Management — AI.IX.D.R6'),
  P('A lazy eight is two symmetrical 180° turns — mismatched pitch rates, bank rates, or coordination between them is an energy-management failure, not a one-off mistake.'),
  P('Too much power leaves you high at the end; too little leaves you low.', 3),

  H('Overbanking Tendency — AI.IX.D.K2'),
  P('Same mechanism as any tight turn — the outside wing outruns the inside wing and generates more lift, wanting to add bank. Most noticeable at the 90° point, in the nose-high, slow part of the turn — hold opposite aileron to keep the target bank.'),

  H('RM: Rudder Control — AI.IX.D.K2, R5'),
  P('As airspeed decays, gradually add right rudder to counter left-turning tendencies, peaking at the slowest point.'),
  P('A right turn needs more right rudder (adverse yaw adds to the left tendencies); a left turn needs less (adverse yaw partly cancels them). In the climbing right turn the controls end up slightly crossed from overbanking — that\'s normal, stay coordinated.', 3),

  P('Bottom line: it can\'t be flown mechanically — constantly changing pressures, divided attention between references, pitch, bank, airspeed, and coordination, with smooth, unhurried inputs at every point.'),
  ...
  P('The airplane stalls at a higher indicated airspeed under the maneuvering loads of a lazy eight, and the break can be more sudden.'),
  B('Recovery: promptly release back pressure, add power, return to coordinated straight-and-level. Prevention: fly it exactly as smooth and unhurried as the name suggests.'),
  ...
  S('Conclusion'),
  P('Review: half-pipe energy transfer · 45°/90°/135° references · 15°-30°-15° bank progression · max pitch at 45°, level pitch/max bank at 90°, max pitch-down at 135° · overbanking & increasing right rudder through the slow half · symmetry between the two turns · common errors · accelerated stalls & collision avoidance.'),
...
window.CFI_SCRIPTS['ix-e-s-turns'] = { nodes: [
  ...
  P('Enter on the downwind, perpendicular to the reference line, and fly a 180° constant-radius turn; cross the line wings-level on the upwind, then fly an identical turn the opposite way.'),
  ...
  A('Roll Rate'),
  P('High roll rate when wind will push you away from the reference or groundspeed is high; low roll rate when wind pushes you toward it or groundspeed is low.', 3),
  A('Bank Angle'),
  ...
  H('Selecting Altitude & Reference'),
  P('Entry altitude 600\'–1,000\' AGL per the ACS, ± 100\' — 800\' AGL is a good balance.'),
  P('Estimate wind, then pick a straight-line reference perpendicular to it (road, tracks, fence line) clear of populated areas and suitable for an emergency landing.', 3),
  H('Entry'),
  P('Approach the line on the downwind, perpendicular to it, at 800\' AGL, on airspeed and trimmed for level flight — give yourself the time and distance to set up cleanly.'),
  ...
  P('Time the rollout to arrive straight-and-level over/perpendicular to the line, judging closure rate and increasing bank as needed to cross wings-level.'),
  A('Altitude (± 100\' per the ACS)'),
  P('Trim for level flight before starting; as bank increases, add back pressure to hold altitude — don\'t fixate on any one thing.', 3),
  A('Airspeed'),
  P('A steady power setting and stable altitude do most of the work; add or reduce power as bank and back pressure change.', 3),
  A('RM: Coordination — AI.IX.E.R5'),
  P('Never use uncoordinated rudder to fix the radius or the rollout — that\'s a cross-controlled situation.', 3),

  S('Common Errors — AI.IX.E.K5'),
  P('Inadequate clearing, initially and throughout · unstable altitude before entry · altitude drift during the maneuver · misjudged wind · imperfect constant-radius turns · rough transitions into turns · wrong wind correction angle · uncoordinated aileron/rudder (slips or skids).'),
  ...
  S('Conclusion'),
  P('Review: 600\'–1,000\' AGL entry (± 100\') · perpendicular reference line · bank and roll rate tied to groundspeed on each half · wind correction angle peaks at each 90° point, crab in on the first turn / out on the second · never fix radius with rudder · common errors · division of attention & collision avoidance.'),
...
window.CFI_SCRIPTS['ix-e-turns-around-a-point'] = { nodes: [
  ...
  P('Crab into any crosswind to hold radius — WCA builds from the start to the 90° point, decreases to the 180° point, then repeats on the other side. First half of the 360: crab into the turn. Second half: crab out of it.', 3),
  A('RM: Coordination — AI.IX.E.R5'),
  ...
  H('RM: Division of Attention — AI.IX.E.R1'),
  P('90% outside, 10% inside — divide attention between the reference point, the aircraft, what\'s coming next, and other traffic.'),

  S('How: Performing Turns Around a Point — AI.IX.E.K1'),
  H('Prior to Entry'),
  P('Altitude 600\'–1,000\' AGL per the ACS, ± 100\' — 800\' AGL is a good balance.'),
  P('Pick a prominent but small, precise reference (a crossroads works well) clear of populated areas and suitable for an emergency landing.', 3),
  P('Technique: pick out additional targets at ¼-circle intervals to help orient with the wind and stay on schedule.', 3),
  ...
  S('Common Errors — AI.IX.E.K5'),
  P('Inadequate clearing, initially and throughout · unstable altitude before entry · altitude drift during the maneuver · misjudged wind · imperfect constant-radius turns · rough control inputs · wrong wind correction angle · uncoordinated aileron/rudder (slips or skids).'),
  ...
  S('Conclusion'),
  P('Review: 600\'–1,000\' AGL entry (± 100\') · ¼–½ mile abeam a small, precise point · bank up to 45°, steepest on entry (tailwind) · crab into the turn on the downwind half, out of it on the upwind half, peaking at each 90° · at least two full turns before rollout · common errors · division of attention & collision avoidance.'),
