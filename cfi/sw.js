...
const CACHE = 'cfi-binder-v4';
const CORE = ['./', './index.html', './custom.js', './data.js', './refs.js'];
...
const isContent = url => /\/(index\.html|custom\.js|data\.js|refs\.js|manifest\.webmanifest)$/.test(url)
