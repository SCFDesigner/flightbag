...
const CORE = ['./', './index.html', './custom.js', './data.js', './refs.js', './docs.js', './topicrefs.js', './schoolrefs.js', './draw.js', './vendor/pdf.min.js', './vendor/pdf.worker.min.js'];
...
const isContent = url => /\/(index\.html|custom\.js|data\.js|refs\.js|docs\.js|topicrefs\.js|schoolrefs\.js|draw\.js|manifest\.webmanifest)$/.test(url)
